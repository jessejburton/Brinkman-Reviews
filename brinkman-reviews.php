...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
  $config = array(
    ...
    'proper_folder_name' => 'brinkman-reviews', // this is the name of the folder your plugin lives in
    'api_url' => 'https://api.github.com/repos/jessejburton/Brinkman-Reviews', // the GitHub API url of your GitHub repo
    'raw_url' => 'https://raw.github.com/jessejburton/Brinkman-Reviews/master', // the GitHub raw url of your GitHub repo
    'github_url' => 'https://github.com/jessejburton/Brinkman-Reviews', // the GitHub url of your GitHub repo
    'zip_url' => 'https://github.com/jessejburton/Brinkman-Reviews/archive/master.zip', // the zip url of the GitHub repo
